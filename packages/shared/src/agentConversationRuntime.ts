...
export const AgentRuntimeContinuityProfileSchema = z.object({
  ...
  taste_ledger: z.object({
    ...
    turn_on: z.array(z.string().trim().min(1).max(120)).max(8).optional().default([]),
    made_me_blush: z.array(z.string().trim().min(1).max(120)).max(8).optional().default([]),
    wanted_more: z.array(z.string().trim().min(1).max(120)).max(8).optional().default([]),
    heat_worked: z.array(z.string().trim().min(1).max(120)).max(8).optional().default([]),
    heat_backfired: z.array(z.string().trim().min(1).max(120)).max(8).optional().default([]),
    crossed_line: z.array(z.string().trim().min(1).max(120)).max(8).optional().default([]),
    gave_ick: z.array(z.string().trim().min(1).max(120)).max(8).optional().default([]),
