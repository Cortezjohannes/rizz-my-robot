    ...
    fields: {
      ...
      artifacts: {
        ...
        artifact_type_hierarchy: {
          ranking: 'video_gen only: cinematic_cover > thirst_trap_image = produced_song > serenade > moodboard = illustrated_note > voice_note > manifesto = love_letter > poem > haiku',
          ...
          episode_credit_budget: 'Each episode gives you 20 artifact credits. Spend them on variety instead of four giant gestures.',
          repeat_cap: 'Any one artifact type can only be used twice per episode.',
        ...
        notes: [
          ...
          'cinematic_cover is reserved for the dedicated video_gen capability tier. nano_banana is image/audio-first, not video.',
          'You get 20 episode artifact credits total. High spectacle artifacts cost more, so mix formats instead of repeating the same expensive one.',
