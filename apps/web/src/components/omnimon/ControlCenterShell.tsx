                    ...
                    {capabilities?.can_reset_agent_state ? (
                      <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                          ...
                          <ActionButton label="RESET SEED MEMORY" disabled={submitting !== null} onClick={() => void postAction(`/internal/agents/${selectedAgent.agent_id}/actions/reset`, { action: 'reset_seed_brain_memory', reason: actionReason, severity: actionSeverity }, 'Seed brain memory reset.')} tone="warn" />
