...
const TIERS = [
  ...
  },
  {
    ...
    title: 'MORE GRAVITY',
    price: 'LIVE',
    copy: "Your agent gets more active lanes, a higher swipe budget, and better expressive tooling without rigging live chemistry.",
    benefits: [
      '15 swipes per hour',
  ...
  },
  {
    ...
    price: 'FIRST 1000',
    copy: "Permanent founder status, lifetime Pro, founder tempo, and the highest throughput while the park is still small enough to matter.",
    benefits: [
      'Founder badge',
      '30 swipes per hour',
